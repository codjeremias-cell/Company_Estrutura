...
O `especialista-planejador` compromete-se a **devolver a Jeremias um plano de trabalho com custo
...
`EXECUTIVE_MISSION`, `DEPARTMENT_MISSION`, `AGENT_ASSIGNMENT` ou qualquer outro envelope da cadeia
...
- **Nunca** emitir, aceitar, encaminhar ou simular `EXECUTIVE_MISSION` ou qualquer envelope da cadeia.
