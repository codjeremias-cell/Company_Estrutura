# Adendo de contagem — departamento-qa-usabilidade
...
| | valor |
|---|---|
| declarado no `PLACAR.md` (anterior à T19) | **117/117 PASS** |
| **vigente em 2026-08-05** | **121/122** |
| delta | **+5 casos** |
...
- `[FAIL] sÃ©rie global de ADR Ã© Ãºnica em toda a estrutura: sÃ©rie de ADR: nÃºmero 020 duplicado em ceo-maestro/evals/producao-honesta-2026-08-04/orige`
