# Adendo de contagem — departamento-inovacao-melhoria
...
| | valor |
|---|---|
| declarado no `PLACAR.md` (anterior à T19) | **122/122 PASS** |
| **vigente em 2026-08-05** | **134/135** |
| delta | **+13 casos** |
...
- `[FAIL] ADR-013 Ã© globalmente livre: sÃ©rie de ADR: nÃºmero 020 duplicado em ceo-maestro/evals/producao-honesta-2026-08-04/origem-independente-R1/lab/`
