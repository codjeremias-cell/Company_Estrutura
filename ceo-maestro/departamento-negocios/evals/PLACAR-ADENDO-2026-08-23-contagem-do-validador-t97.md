...
| **vigente em 2026-08-23, após a tarefa 97** | **246/246** |
...
## O delta: 242 → 246 é +4, e só dois deles eu escrevi

**Dois vêm do par positivo/negativo abaixo, e dois vêm deste arquivo.** As travas de documentação
deste pacote geram um caso por arquivo — `sem placeholder:` e `link resolve:` —, e um adendo novo é
um arquivo novo. Ele é o **único** dos dezesseis em que o próprio adendo mexe na contagem, e por
isso é o único cujo número não fecha na primeira passada: a redeclaração precisa ser conferida
